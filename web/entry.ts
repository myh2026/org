  ...
  const server = Bun.serve({
    ...
    async fetch(req): Promise<Response> {
      ...
      try {
        ...
        // v0.5.18 🛰 远程 Agent（#133）：GET ?action=probe|hosts|plan|ping ——
        // 只读四动作（探测/档案/计划/心跳）。与 CLI org remote / 工具环 remote_*
        // 同源 lib/remote.ts（单一实现防口径漂移）。执行车道（remote exec）在
        // 工具环（process_spawn 门 + 审批在环）与 CLI，Web 面只读四动作。
...
<header>
  ...
  <button id="govexBtn" class="rchip" type="button" title="治理与扩展（v0.5.16+）— 🛡 IaC 扫描 · 🧩 插件 · 🛂 RBAC · 🔌 OpenAPI · 🌐 浏览器快照 · 🩺 查询诊断 · ⌨ 补全/重命名 · 🐞 LSP/DAP 调试 · 🌿 merge/rebase · 👥 团队协作 · ☁ 云生态 · 🛰 远程 Agent">
...
<div id="govexPane" role="dialog" aria-modal="true" aria-labelledby="gxTitle">
  <div class="schhead">
    <div class="tt" id="gxTitle">🛡 治理与扩展 — IaC · 插件 · RBAC · OpenAPI · 浏览器 · 诊断 · 补全/重命名 · git · 👥 协作 · ☁ 云生态 · 🛰 远程 Agent（v0.5.16+）</div>
  ...
  <div class="spwfoot">治理与扩展面板与 CLI / 工具环同源（lib/dbdiag · gitmerge · rbac · iacscan · plugins · openapi · browser · completion · rename · lsp · debug · collab · cloud · remote 单一实现三端消费）—— v0.5.16 「每个功能都有对应操作页面」的延续。</div>
</div>
...
var GX_TABS = [["Iac", "iac"], ["Plug", "plug"], ["Rbac", "rbac"], ["Oapi", "oapi"], ["Web", "web"], ["Dbd", "dbd"], ["Code", "code"], ["Lsp", "lsp"], ["Git", "git"], ["Collab", "collab"], ["Cloud", "cloud"], ["Remote", "remote"]];
function gxTab(sec) {
