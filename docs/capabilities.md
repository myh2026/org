...
> v0.5.8 增补：语义检索/RAG（#19/#22 双 ⬜→✅，+13 测试，全量 447/447，见上方表 19/22 行）；v0.5.7 增补：嵌套执行多重优雅降级（空壳工作区修复 + 三路 dispatch 降级，+3 测试，全量 434/434，见「增补」表）；v0.5.6 在 v0.5.4 底稿之上新增三项（+42 测试，全量 431/431）：
